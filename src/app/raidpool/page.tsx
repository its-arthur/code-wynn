...
export default function RaidpoolPage() {
	...
	const [gambits, setGambits] = useState<GambitResponse | null>(null);
	const [history, setHistory] = useState<RaidHistoryResponse | null>(null);
	...
	const fetchGambits = useCallback(() => {
		setTabLoading("gambits", true);
		setTabError("gambits", null);
		getRaidGambitsCurrent()
			.then(setGambits)
			.catch((e) =>
	...
	const refreshTab = () => {
		...
		else if (tab === "gambits") fetchGambits();
		...
		<Tabs value={tab} onValueChange={setTab} className="space-y-4">
			<div className="flex items-center justify-between gap-2">
				<TabsList>
					...
					<TabsTrigger value="gambits">Gambits</TabsTrigger>
			...
			{/* Gambits */}
			<TabsContent value="gambits" className="space-y-4">
				{errors.gambits && <ErrorBanner message={errors.gambits} />}
